...
scoreboard players set world_score r2 5
execute as @e[scores={tar=0..}] run scoreboard players operation @s tmp1 /= world_score r2
...
#最大値決定(本体pr更新)
scoreboard players set @e[limit=1,sort=nearest,tag=phalanx] pr -2000000000
execute as @e[scores={tar=0..}] run scoreboard players operation @e[limit=1,sort=nearest,tag=phalanx] pr > @s pr
